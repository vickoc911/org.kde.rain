...
ColumnLayout {
    ...
    property string homePath: "/home/" + kuser.loginName + "/.local/share/plasma/wallpapers/org.kde.rain/contents/ui/wallpaper/"
    ...
    Kirigami.FormLayout {
        ...
        RowLayout {
            ...
            Kirigami.FormData.label: i18nd("plasma_applet_org.kde.rain", "RainFlake - number :")
            // Rain properties
            ...
            QtControls2.SpinBox {
                Kirigami.FormData.label: i18nd("plasma_applet_org.kde.rain", "Number of rainflakes:")
        ...
        Loader {
            ...
            function loadWallpaper () {
                let source = (configDialog.currentWallpaper == "org.kde.image") ? "ThumbnailsComponent.qml" :
                    ((configDialog.currentWallpaper == "org.kde.rain") ? "SlideshowComponent.qml" : "");

                let props = {screenSize: screenSize};

                if (configDialog.currentWallpaper == "org.kde.rain") {
